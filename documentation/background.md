...
To this end, we endeavored into architectural reviews of core APIs. See [Settings API](wp-core-architecture-reviews/settings-api.md), Theme Customizer API(currently being written).
